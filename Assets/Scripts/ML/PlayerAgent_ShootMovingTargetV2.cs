...
public class PlayerAgent_ShootMovingTargetV2 : Agent
{
    ...
    private void UpdatePenalties()
    {
        ...
        float penaltyDesiredDistance;
        if (distanceToTarget >= desiredTargetDistance)
        {
            penaltyDesiredDistance = (distanceToTarget - desiredTargetDistance) / 50f * distancePenalty;
        }
        else
        {
            penaltyDesiredDistance = distancePenalty / distanceToTarget;
        }
        AddReward(penaltyDesiredDistance);
